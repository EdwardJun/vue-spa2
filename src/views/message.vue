    ...
    computed: {
        sessionList () { // 会话列表
            ...
            for (let i = 0; i < imSessionList.length; i++) {
                ...
                if (itemObj.name && itemObj.time && itemObj.recentMsg != '@@' && ((global.pageMode == 'club' && itemObj.clubId == global.clubId) || (global.pageMode != 'club' && (Global.isClubInXmdAppId(itemObj.clubId) || (itemObj.type == 'manager'))))) {
