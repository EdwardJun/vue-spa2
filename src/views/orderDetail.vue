                ...
                <div>
                    ...
                    <div>
                        ...
                        <div :class="{ 'not-wx': !global.userAgent.isWX}">
                            ...
                            <router-link tag="div" :to="{ name:'twoCommentReward', query:{ techId: orderData.technicianId, commentId:(clubInfo.comment?clubInfo.comment.id:'')} }">追加打赏</router-link>
                        </div>
                    </div>
                </div>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            submitOrder () { // 确认预约
                ...
                Global.setUmengStatistics(that.category, '确认预约', '订单详情页——确认预约')
            ...
            doClickOrderBtn () {
                ...
                Global.setUmengStatistics(that.category, '再来一单', '订单详情页——再来一单')
                if (that.canOrder) {
