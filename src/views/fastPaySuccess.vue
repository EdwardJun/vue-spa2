...
<template>
  <div class="page" id="fast-pay-success-page" v-show="isReveal">
        ...
        <div class="item-code">
            ...
            <div v-if="global.userAgent.isWX">长按二维码关注“小摩豆”，获取更多优惠信息</div>
            <div v-if="!global.userAgent.isWX">点击保存图片，微信扫码关注，获取更多优惠信息</div>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            /**
             * 二维码统计
             * 从Pay目录下的FastPay、FastClubPay、FastPayCashier文件中移到此处
             */
            afterPay () {
                let that = this
