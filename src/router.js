...
var doc = document
var tArr = location.href.toString().match(/\/(\d{18,24})\/?/)
var clubId = ''
if (tArr && tArr[1]) {
    clubId = tArr[1]
}
...
var pageRouterOption = [
    ...
    {
        path: prefixPath + 'worldCup',
        name: 'worldCup',
        meta: { checkLogin: true, fullPage: true },
        component (resolve) {
            require(['./views/worldCup.vue'], resolve)
        }
    },
    {
        path: prefixPath + 'worldCupList',
        name: 'worldCupList',
        meta: { checkLogin: true, fullPage: true },
        component (resolve) {
            require(['./views/worldCupList.vue'], resolve)
        }
    },
    { // 点评打赏
        path: prefixPath + 'commentReward',
        name: 'commentReward',
        meta: { checkLogin: true, fullPage: true },
        component (resolve) {
            require(['./views/commentReward.vue'], resolve)
        }
    },
    { // 全部评论
        path: prefixPath + 'commentAll',
        name: 'commentAll',
        meta: { checkLogin: true, fullPage: true },
        component (resolve) {
            require(['./views/commentAll.vue'], resolve)
        }
    },
    { // 全部评论
        path: prefixPath + 'twoCommentReward',
        name: 'twoCommentReward',
        meta: { checkLogin: true, fullPage: true },
        component (resolve) {
            require(['./views/twoCommentReward.vue'], resolve)
        }
    }
]
