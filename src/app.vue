...
<template>
    <div id="page-container">
        ...
        <loading-toast v-show="global.loading"></loading-toast>
    </div>
</template>
<script>
    ...
    export default {
        ...
        components: {
            ServiceBtn, ServiceTipPop, Spinner, TelDetail, RewardPop, BindPhonePop, LoadingToast
        },
        mounted () {
            const script = document.createElement('script')
            let location = window.location
            if (location.hostname == 'spa.93wifi.com') {
                script.src = 'https://s19.cnzz.com/z_stat.php?id=1273787928&web_id=1273787928'
            } else {
                script.src = 'https://s19.cnzz.com/z_stat.php?id=1273787860&web_id=1273787860'
            }
        ...
        watch: {
            ...
            '$route' () {
                if (window._czc) {
                    ...
                    let refererUrl = '/'
                    if (location.hostname == 'spa.93wifi.com') {
                        window._czc.push(['_setAccount', '1273787928'])
                    } else {
                        window._czc.push(['_setAccount', '1273787860'])
                    }
